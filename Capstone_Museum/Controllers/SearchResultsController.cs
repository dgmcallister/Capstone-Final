...
namespace Capstone_Museum.Controllers {
	public class SearchResultsController : Controller { // Sends the API results to be formmated for results
		...
		public async static Task<GenResults.RootObject> GetGenResult(GenResults.ResultObject resultObject, String guidPrefix) {
			using (HttpClient client = new HttpClient()) {
				...
				var json = JObject.Parse(response); //separating the object
		...
		public IActionResult ExportResults(String sb) { // Exports the result list to a csv file
